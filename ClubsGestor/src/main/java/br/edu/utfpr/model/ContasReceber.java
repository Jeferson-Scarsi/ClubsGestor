...
public class ContasReceber {
    ...
    public ContasReceber(Empresa idempresa, Long idplanilha, Long idtitulo, Long digitotitulo, Socios idsocio, Usuario idusuario, FormaPagRec idformapagrec, Date dtlancamento, Date dtvencimento, Float valbruto, Float valdesconto, Float valacrescimo, Float valtotliquido, Date dtalteracao) {
